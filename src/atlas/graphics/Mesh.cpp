...
//    namespace graphics
//    {
//        Mesh::Mesh(Renderer2* renderer, Shader* vertexShader, Shader* fragmentShader) :
//            renderer(renderer),
...
//            viewport.y = 0;
//            // TODO
//            //viewport.width = static_cast<float>(renderer->framebuffer()->extent().width);
//            //viewport.height = static_cast<float>(renderer->framebuffer()->extent().height);
//
